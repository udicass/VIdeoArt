...
OUTDIR = Path("outputs/deforum-merged-previews/WOMANS_clear_keyframes_v5")
...
SCENES = [
    "the same woman, close-up portrait, soft smile, studio softbox lighting",
    "the same woman, looking away thoughtfully, warm side light",
    "the same woman, gentle laughter, natural daylight",
    "the same woman, elegant evening portrait, soft bokeh lights behind",
]
NEGATIVE = (
