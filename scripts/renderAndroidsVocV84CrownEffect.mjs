...
const output = path.join(previewRoot, 'androids_dream_VOC_V16_V36_V74_FACES_V84_GRAYV6BACKGROUND_CROWN_STROBE_30SEC_1080.mp4');
const contact = path.join(previewRoot, 'androids_dream_VOC_V16_V36_V74_FACES_V84_GRAYV6BACKGROUND_CROWN_STROBE_30SEC_contact.jpg');
...
execFileSync('ffmpeg', [
  ...
  '-filter_complex', [
    ...
    '[crown][tail][crownmask]maskedmerge,trim=duration=10,setpts=PTS-STARTPTS[crownedTail]',
