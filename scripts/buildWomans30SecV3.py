...
source = Path("outputs/deforum-merged-previews/WOMANS_crt_keyframes_v3")
out = Path(r"D:\SD_Deforum_Fresh\outputs\img2img-images\WOMANS_crt_v3_30sec_frames")
...
for k in range(1, 7):
    ...
    keyframes.append(cv2.resize(enhanced, (target_w, target_h), interpolation=cv2.INTER_LANCZOS4))
