...
const temp = path.join(previewRoot, '_antelope_v114_slow_morph_temp.mp4');
const output = path.join(previewRoot, 'antelope_V6_CONSISTENT_TURN_V114_SLOW_MORPH_20SEC_12FPS_1080.mp4');
const contact = path.join(previewRoot, 'antelope_V6_CONSISTENT_TURN_V114_SLOW_MORPH_20SEC_contact.jpg');
...
console.log(JSON.stringify({ source: 'V114 only', sourceFrames: 12, durationSeconds: 20, fps: 12, output, contact }, null, 2));