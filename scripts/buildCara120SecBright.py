...
bright = Path("outputs/deforum-merged-previews/CARA_keyframes_bright_fixed")
out = Path("outputs/deforum-merged-previews/CARA_120sec_bright_fixed_frames")
out.mkdir(parents=True, exist_ok=True)

target_w, target_h = 720, 1280
keyframes = []
for k in range(1, 25):
    path = bright / f"keyframe_{k:04d}.png"
...
hold_frames = 48  # 2 seconds at 24fps
