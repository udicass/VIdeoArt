...
const settings = {
  ...
  sampler: 'Euler a',
  steps: 22,
  batch_name: 'CARA_DEFORUM_GETUP_V142_20SEC',
  seed_behavior: 'fixed',
  seed_iter_N: 1,
  use_init: true,
  strength: 0.6,
  ...
  prompts: {
    ...
    '120': 'the same figure lifting its head and raising its torso, beginning to rise, gray-blue CRT pixel art, cyan rim glow, dark teal dot-matrix background',
    '240': 'the same figure sitting upright, mid rise, gray-blue CRT pixel art, cyan rim glow, dark teal dot-matrix background',
    '360': 'the same figure rising to a standing position, gray-blue CRT pixel art, cyan rim glow, dark teal dot-matrix background',
    '479': 'the same figure standing upright, full body, gray-blue CRT pixel art, cyan rim glow, dark teal dot-matrix background'
  },
  positive_prompts: '',
...
writeFileSync(
  path.join(previewRoot, 'CARA_DEFORUM_GETUP_V142_20SEC_submit.json'),
