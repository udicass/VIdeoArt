...
frames_dir = Path(r"D:\SD_Deforum_Fresh\outputs\androids-text-frames\2026-08-15\seated_ANTELOPE_BEND_V134_30SEC")
...
# Build the static feathered region: head/neck only, fading at neck base and sides.
...
def render(progress: float) -> np.ndarray:
    ...
    # Lateral bend (neck curves) plus a slight forward compression and dip.
...
if args.preview:
    ...
    cv2.imwrite(str(preview_root / "seated_ANTELOPE_BEND_V134_preview.png"), comparison)
else:
