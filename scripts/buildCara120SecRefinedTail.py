...
refined_v2 = Path("outputs/deforum-merged-previews/CARA_keyframes_refined_v2")
out = Path("outputs/deforum-merged-previews/CARA_120sec_refined_tail_frames")
out.mkdir(parents=True, exist_ok=True)

target_w, target_h = 720, 1280
keyframes = []
for k in range(1, 25):
    directory = refined_v2 if k >= 3 else upscaled
