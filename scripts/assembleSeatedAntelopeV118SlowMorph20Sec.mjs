...
const temp = path.join(previewRoot, '_seated_antelope_v118_slow_morph_temp.mp4');
const output = path.join(previewRoot, 'seated_ANTELOP_CRT_CUDA_V118_SLOW_MORPH_20SEC_12FPS_1080.mp4');
const contact = path.join(previewRoot, 'seated_ANTELOP_CRT_CUDA_V118_SLOW_MORPH_20SEC_contact.jpg');
...
console.log(JSON.stringify({ source: 'antelop.png', sourceFrames: 12, durationSeconds: 20, fps: 12, output, contact }, null, 2));