...
const outputDir = 'D:\\SD_Deforum_Fresh\\outputs\\androids-text-frames\\2026-08-14\\androids_dream_VOC_ANDROGYNOUS_TWO_CHARS_CUDA_V94_20SEC';
const contact = path.join(previewRoot, 'androids_dream_VOC_ANDROGYNOUS_TWO_CHARS_CUDA_V94_20SEC_contact.jpg');
...
const descriptors = [
  'dramatic androgynous face, dark lips, heavy dark eye makeup, hair pulled back, intense gaze',
  'younger androgynous face, short dark hair, subtle calm expression, soft direct gaze',
  'sharp androgynous bone structure, smoky dark eye shadow, slicked-back hair, steady stare',
  'soft androgynous face, cropped dark hair, faint neutral mouth, wide clear eyes',
  'angular androgynous features, dark matte lips, sculpted cheeks, slicked hair, piercing gaze',
  'youthful androgynous face, tousled short dark hair, understated look, even level eyes',
  'high cheekbones, dark lip color, tight pulled-back hair, unblinking centered stare',
  'rounded androgynous face, short side-swept hair, gentle eyes, minimal expression',
  'strong jawline, dark smoky eyes, hair scraped back, cool confident gaze',
  'delicate androgynous features, close-cropped hair, calm gaze, pale smooth skin',
  'dramatic kohl-lined eyes, deep dark lips, hair gelled back, frontal stare',
  'soft boyish face, short layered dark hair, subtle mouth, direct gentle gaze',
  'sculpted androgynous profile, dark eyeliner, short slicked hair, intense focus',
  'gentle androgynous face, short wavy dark hair, relaxed brows, steady eyes',
  'sharp cheekbones, matte dark lips, pulled-back hair, bold centered stare',
  'fresh androgynous face, cropped fringe, soft direct gaze, neutral lips',
  'defined brow, heavy dark eye makeup, tight hairstyle, striking frontal look',
  'soft androgynous face, short neat dark hair, calm even features, level eyes',
  'striking androgynous look, dark lips and smoky eyes, hair swept back, fixed gaze',
  'subdued androgynous face, short dark hair, faint expression, clear direct eyes'
];
...
for (let index = 0; index < 20; index += 1) {
  ...
  const response = await fetch('http://127.0.0.1:7860/sdapi/v1/txt2img', {
    ...
    body: JSON.stringify({
      prompt: [basePrompt, descriptors[index], 'clean eyes and stable facial anatomy'].join(', '),
  ...
  process.stdout.write(`generated V94 androgynous face ${index + 1}/20\n`);
}
...
console.log(JSON.stringify({ generatedFrames: 20, mode: 'txt2img-androgynous-two-chars', outputDir, contact, steps: 36, restoreFaces: true }, null, 2));
