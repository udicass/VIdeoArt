...
# 60-second CLEAR movie from 12 freshly generated figures.
# Each figure is held crisply for 3 seconds with smooth, glitch-free crossfades.
KEYDIR = Path("outputs/deforum-merged-previews/WOMANS_clear_keyframes_v4")
out = Path("outputs/deforum-merged-previews/WOMANS_CRT_V2_CLEAR_60SEC_NEW_frames")
