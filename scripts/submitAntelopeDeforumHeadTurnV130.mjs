...
settings.batch_name = 'antelope_DEFORUM_HEAD_TURN_V130_90FRAMES';
settings.max_frames = 91;
settings.init_image = 'D:/Users/User/Sonar/VIdeoArt/outputs/deforum-merged-previews/antelope.png';
settings.strength_schedule = '0: (0.72)';
settings.noise_schedule = '0: (0.0)';
settings.cfg_scale_schedule = '0: (6.0)';
...
writeFileSync(
  path.join(previewRoot, 'antelope_DEFORUM_HEAD_TURN_V130_90FRAMES_submit.json'),
